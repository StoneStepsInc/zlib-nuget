...
build steps in win32/Makefile.msc, adapted to generate static
libraries referencing debug CRT for Debug configurations.
...
work for any other configuration names. Do not install this
